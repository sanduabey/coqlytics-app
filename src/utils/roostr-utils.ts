...
//Roostr
const nft: string = 'Roostr'
const collName: string = 'roostr-sales'
const nftDataAPIURI: string = 'https://api.chikn.farm/api/roostr/details'
const address: string = process.env.ROOSTR_CONTRACT_ADDRESS as string

export const getRoostrSalesByDate = async (from: Date, to: Date) => {
  try {
