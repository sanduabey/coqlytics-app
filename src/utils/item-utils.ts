...
//Items
const nft: string = 'Item'
const collName: string = 'item-sales'
const address: string = process.env.ITEM_CONTRACT_ADDRESS as string

export const getItemSalesByDate = async (from: Date, to: Date) => {
  try {
...
export const startItemDataCron = async () => {
  await Moralis.start({
